...
//Header
		...
		$pdf->Ln(5);
                ...
                if($infaq==NULL){ $infa=""; $inf='...........................'; }else{$infa=$pdf->Terbilang($infaq->inf_blangko); $inf=$infaq->inf_blangko;}
                ...
                $pdf->Cell(50,6,'Guna membayar',0,0,'L'); $pdf->Cell(3,6,':',0,0,'L'); $pdf->Cell(120,6,' Infaq Madrasah Qudsiyyah Kudus (Pengambilan blangko Pendaftaran)',0,1,'L');
                $pdf->Ln(5);
                ...
                $pdf->Output('Kwitansi Ambil Blangko '.$datasiswa->tmb_no_daftar.'.pdf','I');	
?>		